...
class hilbert(object):
    ...
    def _draw_frame_line( self, p_start, p_end, margin ):
        ...
        track.SetStart( pcbnew.VECTOR2I(pcbnew.wxPointMM( float(p_start[0]-margin), float(p_start[1]-margin) ) ))
        track.SetEnd  ( pcbnew.VECTOR2I(pcbnew.wxPointMM( float(  p_end[0]-margin), float(  p_end[1]-margin) ) ))
    ...
    def putLabel(self):
        ...
        text.SetPosition( pcbnew.VECTOR2I(pcbnew.wxPointMM( float(self.size+5), float(5) ) ))
